...
import { getFunctionArgType, isExpressionType } from './config';
    ...
    constructor(config = {}) {
        ...
        $.RULE('any', (returnType) => {
            $.OR({
                DEF: [
                    {
                        GATE: () => !returnType || isExpressionType('aggregation', returnType),
                        ALT: () => {
        ...
        $.RULE('atomicExpression', (returnType) => {
            $.OR({
                DEF: [
                    ...
                    // expressions
                    {
                        GATE: () => isExpressionType('string', returnType) || isExpressionType('number', returnType),
                        ALT: () =>
